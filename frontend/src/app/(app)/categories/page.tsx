				...
				{filtered.length === 0 ? (
					<Card className="flex flex-col items-center justify-center py-16 text-center">
						...
						<p className="text-sm text-fg-muted">
							No {TYPE_LABELS[tab].toLowerCase()} categories yet
						</p>
						<button
							onClick={openAdd}
				...
				>
					<form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
						...
						<div className="flex flex-col gap-1.5">
							<label htmlFor="category-name" className="text-sm font-medium text-fg">
								Name
							</label>
							<input
								id="category-name"
						...
						<div className="flex flex-col gap-1.5">
							<label htmlFor="category-type" className="text-sm font-medium text-fg">
								Type
							</label>
							<select
								id="category-type"
								value={form.type}
								onChange={(e) =>
									setForm((f) => ({ ...f, type: e.target.value as TabType }))
								}
