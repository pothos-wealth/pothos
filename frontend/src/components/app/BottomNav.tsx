                        ...
                        <div className="px-4 py-3 flex flex-col gap-1 pb-8">
                            <Link
                                ...
                                className={`flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition-colors duration-150 ${
                                    pathname === '/categories' ? 'bg-accent-light text-primary' : 'text-fg hover:bg-bg-3'
                                }`}
                            >
                            ...
                            <Link
                                ...
                                onClick={() => setMoreOpen(false)}
                                className={`flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition-colors duration-150 ${
                                    pathname === '/settings' ? 'bg-accent-light text-primary' : 'text-fg hover:bg-bg-3'
                                }`}
                            >
                            ...
                            {user?.isSuperadmin && (
                                <Link
                                    ...
                                    onClick={() => setMoreOpen(false)}
                                    className={`flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition-colors duration-150 ${
                                        pathname.startsWith('/admin') ? 'bg-accent-light text-primary' : 'text-fg hover:bg-bg-3'
                                    }`}
                                >
