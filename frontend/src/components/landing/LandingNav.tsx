			...
			<div className="mx-auto max-w-6xl px-6 py-3.5 flex items-center justify-between">
				...
				<div className="flex items-center gap-4">
					...
					{user === "loading" ? null : user ? (
						<Link
							href="/settings"
							className="w-8 h-8 rounded-full bg-accent-light text-primary font-semibold text-sm flex items-center justify-center uppercase hover:bg-accent transition-colors duration-200"
						>
							{user.email[0]}
						</Link>
					) : (
